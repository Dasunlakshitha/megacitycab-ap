...
<div class="flex">
    ...
    <div class="flex-1 p-8">
        ...
        <div class="mb-6 p-4 bg-white shadow-md rounded-lg">
            ...
            <p class="text-gray-600">Email: <%= user.getEmail() %></p>
        </div>
        <% } %>
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <table class="min-w-full">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4"><%= booking.getDriver() != null ? booking.getDriver().getName() : "No Driver Assigned" %></td>
                    <td class="px-6 py-4"><%= booking.getVehicle() != null ? booking.getVehicle().getModel() : "No Vehicle Assigned" %></td>
                ...
                <% }} else { %>
                <tr>
                    <td colspan="7" class="text-center px-6 py-4 text-gray-500">No bookings found.</td>
                </tr>
                <% } %>
                </tbody>
            </table>
