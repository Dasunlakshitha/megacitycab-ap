...
<head>
    ...
    <title>Customer Management - Car Booking System</title>
    ...
    <div class="flex-1 p-8">
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <table class="min-w-full">
                ...
                %>
                <tr>
                    <td class="px-6 py-4"><%= customer.getId() %></td>
                    <td class="px-6 py-4"><%= customer.getName() %></td>
                    <td class="px-6 py-4"><%= customer.getEmail() %></td>
                    <td class="px-6 py-4"><%= customer.getPhone() %></td>
                    <td class="px-6 py-4">
                        <a href="/edit-customer/<%= customer.getId() %>"
                           class="text-blue-500 hover:text-blue-700 mr-2">
                            <i class="fas fa-edit"></i>
                        </a>
                        <a href="/delete-customer/<%= customer.getId() %>"
