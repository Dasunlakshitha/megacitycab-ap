...
<head>
    ...
    <title>Create Payment - Car Booking System</title>
    <link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css" rel="stylesheet">
</head>
<body class="bg-gray-100 flex items-center justify-center h-screen">
<div class="bg-white p-8 rounded-lg shadow-md w-96">
    <h1 class="text-2xl font-bold mb-6 text-center">Create Payment</h1>
    ...
    <form id="createPaymentForm" class="space-y-4">
        <div>
            ...
            <select id="bookingId" name="bookingId" required
                ...
                <option value="<%= booking.getId() %>"><%= booking.getId() %></option>
                <% }
                } %>
            </select>
        </div>
