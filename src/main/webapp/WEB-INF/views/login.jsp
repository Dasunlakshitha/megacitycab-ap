...
<div class="bg-white p-8 rounded-lg shadow-md w-96">
    ...
    <form id="loginForm" class="space-y-4">
        ...
        <div>
            <button type="submit" id="login-button" class="w-full bg-blue-500 text-white py-2 px-4 rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                Login
            </button>
        </div>
    </form>
